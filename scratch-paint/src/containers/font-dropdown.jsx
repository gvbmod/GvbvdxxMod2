...
class FontDropdown extends React.Component {
    constructor (props) {
        ...
        bindAll(this, [
			...
			'handleChangeFontslkscr',
            'handleOpenDropdown',
            'handleClickOutsideDropdown',
			'handleChangeFontScratch',
			'handleChangeFontArial',
			'handleChangeFontsystemUI',
			'handleChangeFontmonospace',
            'setDropdown',
            'handleChoose'
        ]);
    }
	...
	handleChangeFontslkscr () {
        if (this.dropDown.isOpen()) {
            this.props.changeFont(Fonts.slkscr);
        }
    }
	handleChangeFontScratch () {
        if (this.dropDown.isOpen()) {
	...
	handleChangeFontsystemUI () {
        if (this.dropDown.isOpen()) {
            this.props.changeFont(Fonts.systemUI);
        }
    }
	handleChangeFontmonospace () {
        if (this.dropDown.isOpen()) {
            this.props.changeFont(Fonts.monospace);
        }
    }
	handleChangeFontArial () {
        if (this.dropDown.isOpen()) {
            this.props.changeFont(Fonts.Arial);
        }
    }
    handleChangeFontKorean () {
        if (this.dropDown.isOpen()) {
    ...
    render () {
        return (
            <FontDropdownComponent
				...
				onHoverslkscr={this.handleChangeFontslkscr}
				onHoverScratch={this.handleChangeFontScratch}
				onHoverArial={this.handleChangeFontArial}
				onHoversystemUI={this.handleChangeFontsystemUI}
				onHovermonospace={this.handleChangeFontmonospace}
